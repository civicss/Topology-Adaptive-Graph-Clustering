...
'''1. 初始化'''
def initial():
    if args.name == 'facebook':
        args.file_name = './output_4_facebook/facebook_result_m4_2.txt'  # 结果文件名字
        args.lr = 1e-3                      # 学习率
        args.k = 3                          # 构建 k 近邻的节点数量
        args.n_clusters = 7                 # 聚类类别数目     
        args.n_input = 16                   # 输入特征维度
...
if __name__ == "__main__":
    ...
    parser.add_argument('--file_name', type=str, default='facebook')            # 输出结果文件名字
